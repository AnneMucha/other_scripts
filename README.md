Repository for scripts from ongoing projects, currently includes:
...
- R code for pre-processing, plotting and analysing data from an interactive communication experiment
